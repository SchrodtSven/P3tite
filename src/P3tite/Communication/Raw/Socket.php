...
class Socket
{
    ...
    public function bindAndListen(): self
    {
    ...
    public function write(\Socket $socket, string $message): self
    {
        socket_write($socket, $message, strlen($message));
        return $this;
    }

    public function read(\Socket $socket, int $mode = \PHP_BINARY_READ, int $length = self::DEFAULT_READ_LENGTH): string|false
    {
    ...
    public function closeSocket(\Socket $socket): self
    {
        socket_close($socket);
        return $this;
    }
